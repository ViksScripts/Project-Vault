...
local old_click = CoreGui:FindFirstChild('OxyoHub')

if old_click then
    Debris:AddItem(old_click, 0)
end

if not isfolder("OxyoHub") then
    makefolder("OxyoHub")
end
...
local Config = setmetatable({
    save = function(self: any, file_name: any, config: any)
        local success_save, result = pcall(function()
            ...
            writefile('OxyoHub/'..file_name..'.json', flags)
        end)
    ...
    load = function(self: any, file_name: any, config: any)
        local success_load, result = pcall(function()
            if not isfile('OxyoHub/'..file_name..'.json') then
                self:save(file_name, config)
        
                return
            end
        
            local flags = readfile('OxyoHub/'..file_name..'.json')
...
function Library.SendNotification(settings)
    ...
    InnerFrame.BackgroundColor3 = Color3.fromRGB(8, 51, 8)
...
function Library:create_ui()
    ...
    Container.BorderColor3 = Color3.fromRGB(8, 51, 8)
    Container.AnchorPoint = Vector2.new(0.5, 0.5)
    Container.Name = 'Container'
    Container.BackgroundTransparency = 0.05
    Container.BackgroundColor3 = Color3.fromRGB(8, 51, 8)
    ...
    ClientName.TextColor3 = Color3.fromRGB(68, 153, 68)
...
task.spawn(function()
    while true do
        ClientName.Text = " Oxyo hub " .. spinChars[i] .. " " .. os.date("%I:%M:%S %p")
        i = i % #spinChars + 1
        task.wait(0.2)
    end
end)
    ...
    ClientName.BorderColor3 = Color3.fromRGB(8, 51, 8)
    ...
    UIGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(68, 153, 68)),
    ...
    Pin.BackgroundColor3 = Color3.fromRGB(68, 153, 68)
    Pin.Parent = Handler
    ...
    Divider.BackgroundColor3 = Color3.fromRGB(51, 128, 51)
            ...
            if object == tab then
                if object.BackgroundTransparency ~= 0.5 then
                    ...
                    TweenService:Create(object.TextLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        ...
                        TextColor3 = Color3.fromRGB(68, 153, 68)
                    }):Play()
                    ...
                    TweenService:Create(object.Icon, TweenInfo.new(3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        ...
                        ImageColor3 = Color3.fromRGB(68, 153, 68)
                    }):Play()
                end
    ...
    function self:create_tab(title: string, icon: string)
        ...
        Tab.TextColor3 = Color3.fromRGB(8, 51, 8)
        Tab.BorderColor3 = Color3.fromRGB(8, 51, 8)
        Tab.Text = ''
        ...
        Tab.TextSize = 14
        Tab.BackgroundColor3 = Color3.fromRGB(51, 128, 51)
        Tab.Parent = Tabs
        ...
        UIGradient.Color = ColorSequence.new{
            ...
            ColorSequenceKeypoint.new(0.7, Color3.fromRGB(68, 153, 68)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(8, 51, 8))
        }
        ...
        function TabManager:create_module(settings: any)
            ...
            local UIStroke = Instance.new('UIStroke')
            UIStroke.Color = Color3.fromRGB(51, 128, 51)
            UIStroke.Transparency = 0.5
            UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
            ...
            Header.TextColor3 = Color3.fromRGB(8, 51, 8)
            ...
            ModuleName.TextColor3 = Color3.fromRGB(68, 153, 68)
            ModuleName.TextTransparency = 0.20000000298023224
            if not settings.rich then
                ModuleName.Text = settings.title or "Skibidi"
            else
                ModuleName.RichText = true
                ModuleName.Text = settings.richtext or "<font color='rgb(255,0,0)'>Oxyo hub</font> user"
            end;
            ...
            ModuleName.BorderColor3 = Color3.fromRGB(8, 51, 8)
            ...
            Description.TextColor3 = Color3.fromRGB(68, 153, 68)
            ...
            Description.BorderColor3 = Color3.fromRGB(8, 51, 8)
            ...
            Toggle.BackgroundColor3 = Color3.fromRGB(51, 128, 51)
            ...
            Circle.BackgroundColor3 = Color3.fromRGB(51, 128, 51)
            ...
            Keybind.BorderColor3 = Color3.fromRGB(8, 51, 8)
            Keybind.Size = UDim2.new(0, 33, 0, 15)
            Keybind.BorderSizePixel = 0
            Keybind.BackgroundColor3 = Color3.fromRGB(68, 153, 68)
            ...
            Divider.BorderSizePixel = 0
            Divider.BackgroundColor3 = Color3.fromRGB(8, 51, 8)
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                if not settings.rich then
                    ...
                    Body.RichText = true
                    Body.Text = settings.richtext or "<font color='rgb(255,0,0)'>Oxyo hub</font> user"
                end
            ...
            function ModuleManager:create_text(settings: any)
                ...
                function TextManager:Set(new_settings)
                    if not new_settings.rich then
                        ...
                        Body.RichText = true
                        Body.Text = new_settings.richtext or "<font color='rgb(255,0,0)'>Oxyo hub</font> user"
                    end
                end;
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                Checkbox.TextColor3 = Color3.fromRGB(8, 51, 8)
                Checkbox.BorderColor3 = Color3.fromRGB(8, 51, 8)
                Checkbox.Text = ""
                ...
                Checkbox.BackgroundColor3 = Color3.fromRGB(8, 51, 8)
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(68, 153, 68)
                Drag.Parent = Slider
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                Dropdown.TextColor3 = Color3.fromRGB(8, 51, 8)
                Dropdown.BorderColor3 = Color3.fromRGB(8, 51, 8)
                Dropdown.Text = ''
