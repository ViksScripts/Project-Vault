...
OpenButton.Size = isMobile and UDim2.new(0, 65, 0, 65) or UDim2.new(0, 40, 0, 40)
OpenButton.Position = isMobile and UDim2.new(1, -80, 0.5, -32) or UDim2.new(1, -55, 0.5, -20)
OpenButton.BackgroundColor3 = Color3.fromRGB(30, 30, 50)
OpenButton.BackgroundTransparency = 0.15
OpenButton.Text = "ODH"
OpenButton.TextColor3 = Color3.fromRGB(255, 255, 255)
OpenButton.TextSize = isMobile and 16 or 12
...
local draggingBtn, dragBtnInput, dragBtnStart, dragBtnPos
OpenButton.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        draggingBtn = true
        dragBtnStart = input.Position
        dragBtnPos = OpenButton.Position
    end
end)
...
UserInputService.InputChanged:Connect(function(input)
    if input == dragBtnInput and draggingBtn then
        ...
        OpenButton.Position = UDim2.new(dragBtnPos.X.Scale, dragBtnPos.X.Offset + delta.X, dragBtnPos.Y.Scale, dragBtnPos.Y.Offset + delta.Y)
    end
end)
...
MainFrame.Size = isMobile and UDim2.new(0, 380, 0, 520) or UDim2.new(0, 550, 0, 400)
...
CloseBtn.Position = UDim2.new(1, -(isMobile and 50 or 40), 0, isMobile and 5 or 5)
...
OpenButton.MouseButton1Click:Connect(function()
    ...
    BlurFrame.Visible = MainFrame.Visible
...
NavFrame.Size = UDim2.new(0, isMobile and 110 or 130, 1, -(isMobile and 60 or 50))
NavFrame.Position = UDim2.new(0, isMobile and 5 or 10, 0, isMobile and 55 or 45)
...
NavFrame.ElasticBehavior = Enum.ElasticBehavior.Never
...
for _, tab in ipairs(tabs) do
    CreateNavButton(tab.name, tab.icon)
end

-- Контент
local ContentFrame = Instance.new("ScrollingFrame")
ContentFrame.Size = UDim2.new(1, -(isMobile and 120 or 150), 1, -(isMobile and 60 or 50))
ContentFrame.Position = UDim2.new(0, isMobile and 120 or 145, 0, isMobile and 55 or 45)
ContentFrame.BackgroundTransparency = 1
ContentFrame.BorderSizePixel = 0
ContentFrame.ScrollBarThickness = isMobile and 4 or 3
...
ContentList.Padding = UDim.new(0, isMobile and 8 or 6)
...
local function CreateSection(title)
    ...
    titleLbl.Size = UDim2.new(1, -20, 0, isMobile and 30 or 24)
    titleLbl.Position = UDim2.new(0, 10, 0, 4)
    titleLbl.BackgroundTransparency = 1
    titleLbl.Text = title
    titleLbl.TextColor3 = Color3.fromRGB(255, 255, 255)
    titleLbl.TextSize = isMobile and 14 or 12
    ...
    container.Position = UDim2.new(0, 10, 0, isMobile and 34 or 30)
    container.BackgroundTransparency = 1
    container.AutomaticSize = Enum.AutomaticSize.Y
    container.Parent = section
    
    local list = Instance.new("UIListLayout")
    list.Padding = UDim.new(0, isMobile and 6 or 4)
    list.Parent = container
    
    local pad = Instance.new("UIPadding")
    pad.PaddingBottom = UDim.new(0, isMobile and 8 or 6)
    pad.Parent = section
...
local function CreateToggle(parent, text, default, callback)
    ...
    toggle.Size = UDim2.new(1, 0, 0, isMobile and 36 or 28)
    ...
    label.Size = UDim2.new(1, -(isMobile and 60 or 50), 1, 0)
    ...
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0, isMobile and 44 or 36, 0, isMobile and 24 or 18)
    btn.Position = UDim2.new(1, -(isMobile and 50 or 42), 0.5, -(isMobile and 12 or 9))
    ...
    dot.Size = UDim2.new(0, isMobile and 16 or 12, 0, isMobile and 16 or 12)
    dot.Position = default and UDim2.new(1, -(isMobile and 20 or 16), 0.5, -(isMobile and 8 or 6)) or UDim2.new(0, 4, 0.5, -(isMobile and 8 or 6))
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        dot.Position = state and UDim2.new(1, -(isMobile and 20 or 16), 0.5, -(isMobile and 8 or 6)) or UDim2.new(0, 4, 0.5, -(isMobile and 8 or 6))
...
local function CreateSlider(parent, text, min, max, default, callback)
    ...
    slider.Size = UDim2.new(1, 0, 0, isMobile and 46 or 38)
    ...
    local label = Instance.new("TextLabel")
    label.Size = UDim2.new(0.6, -10, 0, isMobile and 20 or 16)
    ...
    value.Size = UDim2.new(0.4, -10, 0, isMobile and 20 or 16)
    value.Position = UDim2.new(0.6, 0, 0, 2)
    value.BackgroundTransparency = 1
    value.Text = tostring(default)
    value.TextColor3 = Color3.fromRGB(150, 200, 255)
    value.TextSize = isMobile and 12 or 10
    value.Font = Enum.Font.GothamBold
    value.TextXAlignment = Enum.TextXAlignment.Right
    value.Parent = slider
    
    local bg = Instance.new("Frame")
    bg.Size = UDim2.new(1, -16, 0, isMobile and 6 or 4)
    bg.Position = UDim2.new(0, 8, 1, -(isMobile and 12 or 10))
    ...
    handle.Size = UDim2.new(0, isMobile and 16 or 10, 0, isMobile and 16 or 10)
    handle.Position = UDim2.new(1, -(isMobile and 8 or 5), 0.5, -(isMobile and 8 or 5))
...
local function CreateButton(parent, text, callback)
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(1, 0, 0, isMobile and 36 or 28)
...
local function CreateLabel(parent, text, rich)
    ...
    lbl.Size = UDim2.new(1, 0, 0, isMobile and 24 or 20)
...
local function CreateDropdown(parent, text, options, default, callback)
    ...
    dropdown.Size = UDim2.new(1, 0, 0, isMobile and 36 or 28)
    ...
    btn.Position = UDim2.new(0.5, 0, 0.5, -(isMobile and 13 or 10))
    btn.BackgroundColor3 = Color3.fromRGB(50, 50, 70)
    btn.BorderSizePixel = 0
...
local function CreateColorPicker(parent, text, defaultColor, callback)
    ...
    picker.Size = UDim2.new(1, 0, 0, isMobile and 36 or 28)
    ...
    colorBox.Size = UDim2.new(0, isMobile and 38 or 30, 0, isMobile and 24 or 18)
    colorBox.Position = UDim2.new(1, -(isMobile and 44 or 38), 0.5, -(isMobile and 12 or 9))
    ...
    colorBox.MouseButton1Click:Connect(function()
        ...
        presetFrame.Size = UDim2.new(1, 0, 0, isMobile and 80 or 60)
        ...
        grid.CellSize = UDim2.new(0, isMobile and 28 or 22, 0, isMobile and 28 or 22)
        grid.CellPadding = UDim2.new(0, 4, 0, 4)
        grid.FillDirectionMaxCells = isMobile and 5 or 7
        ...
        for _, color in ipairs(presets) do
            ...
            pBtn.Size = UDim2.new(0, isMobile and 28 or 22, 0, isMobile and 28 or 22)
            ...
            pBtn.TouchTap:Connect(function()
                currentColor = color
                colorBox.BackgroundColor3 = currentColor
                if callback then pcall(callback, currentColor) end
                if presetFrame then presetFrame:Destroy() end
    ...
    colorBox.TouchTap:Connect(function()
        if expanded and presetFrame then
            presetFrame:Destroy()
            presetFrame = nil
            expanded = false
...
local function CreateKeybind(parent, text, defaultKey, callback)
    ...
    keybind.Size = UDim2.new(1, 0, 0, isMobile and 36 or 28)
    ...
    local label = Instance.new("TextLabel")
    label.Size = UDim2.new(1, -(isMobile and 90 or 80), 1, 0)
    label.Position = UDim2.new(0, 8, 0, 0)
    label.BackgroundTransparency = 1
    label.Text = text
    label.TextColor3 = Color3.fromRGB(200, 200, 200)
    ...
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0, isMobile and 80 or 70, 0, isMobile and 26 or 20)
    btn.Position = UDim2.new(1, -(isMobile and 86 or 76), 0.5, -(isMobile and 13 or 10))
    btn.BackgroundColor3 = Color3.fromRGB(50, 50, 70)
    btn.BorderSizePixel = 0
    btn.Text = defaultKey
    btn.TextColor3 = Color3.fromRGB(255, 255, 255)
...
function LoadTab(tabName)
    ...
    elseif tabName == "Sound" then
        ...
        textBox.Size = UDim2.new(1, 0, 0, isMobile and 30 or 24)
...
-- ==================== AUTO START ====================
LoadTab("Visuals")
print("[BetterODH] Loaded! Press the ODH button or RightShift to open GUI.")